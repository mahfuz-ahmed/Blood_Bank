...
namespace BloodBank.Controllers
{
    public class DonnersController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.Thana_ID = new SelectList(db.Thanas, "ThanaID", "ThanaName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Donner_ID,Donner_Name,Group_ID,District_ID,Thana_ID,ContactNumber,Email,LastDonationDate,Status")] Donner donner)
        {
            ...
            ViewBag.Thana_ID = new SelectList(db.Thanas, "ThanaID", "ThanaName", donner.Thana_ID);
            return View(donner);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Donner_ID,Donner_Name,Group_ID,District_ID,Thana_ID,ContactNumber,Email,LastDonationDate,Status")] Donner donner)
        {
            if (ModelState.IsValid)
            {
